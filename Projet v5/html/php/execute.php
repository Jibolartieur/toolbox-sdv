...
$allowed_tools = [
    ...
    'nuclei' => function($target) {
        return "sudo -u www-data /home/matthis/go/bin/nuclei -u {$target} -stats -silent -no-color -t /var/www/nuclei-templates/";
    },


    'subfinder' => function($target) {
        return "sudo -u www-data /home/matthis/go/bin/subfinder -d {$target} -silent \
";
    }
];
